...
sd_theta_all = pd.read_csv("C:/Users/Lucie/Documents/ECOLES/DTU/Time series analysis/Assignment 1/21.12.2023/sd.theta.all.csv")
sigma_all  = pd.read_csv("C:/Users/Lucie/Documents/ECOLES/DTU/Time series analysis/Assignment 1/21.12.2023/sigma.all.csv")
...
epsilon = pd.read_csv("C:/Users/Lucie/Documents/ECOLES/DTU/Time series analysis/Assignment 1/21.12.2023/epsilon.all.csv")
sd_theta_all = pd.read_csv("C:/Users/Lucie/Documents/ECOLES/DTU/Time series analysis/Assignment 1/21.12.2023/sd.theta.all.csv")
sigma_all  = pd.read_csv("C:/Users/Lucie/Documents/ECOLES/DTU/Time series analysis/Assignment 1/21.12.2023/sigma.all.csv")
data_without_last_years2["sd_theta_all1"] = sd_theta_all.V1
data_without_last_years2["sd_theta_all2"] = sd_theta_all.V2
...
martin_data = pd.read_csv("C:/Users/Lucie/Documents/ECOLES/DTU/Time series analysis/Assignment 1/21.12.2023/from_martin.csv")
...
ax4.scatter(data_without_last_years2.time, data_without_last_years2.co2, label="Observations", s=1)
ax4.scatter(data_without_last_years2.time, data_without_last_years2.y_pred, label="Predictions", s=1)
ax4.plot(data_without_last_years2.time, data_without_last_years2.y_pred_down, label="Lower bound")#, s=1)
ax4.plot(data_without_last_years2.time, data_without_last_years2.y_pred_up, label="Upper bound")#, s=1)
ax4.set_title("...")
ax4.set_xlabel("Time (y)")
ax4.set_ylabel("CO2 concentration (ppm)")
ax4.legend()
