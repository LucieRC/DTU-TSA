...
for (i in begin:n){
  ...
  epsilon.all[i] <- epsilon_for_sigma
...
## Question 1.3.3
write.csv(epsilon.all,"../created_data/1.3.3_epsilon.all.csv")
write.csv(sigma.all,"../created_data/1.3.3_sigma.all.csv")
write.csv(sigma.local,"../created_data/1.3.3_sigma.local.csv")
write.csv(theta.all,"../created_data/theta.all.csv")

## Question 1.3.4
write.csv(y_est,"../created_data/1.3.4_y_est_lambda_0.9.csv")
write.csv(y_pred_down,"../created_data/1.3.4_pred_down_lambda_0.9.csv")
write.csv(y_pred_up,"../created_data/1.3.4_pred_down_lambda_0.9.csv")
...
write.csv(y_est,"../created_data/y_est_lambda_0.9.csv")
write.csv(y_pred_down,"../created_data/pred_down_lambda_0.9.csv")
write.csv(y_pred_up,"../created_data/pred_up_lambda_0.9.csv")
